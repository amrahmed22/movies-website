...
const Tv = () => {
    ...
    async function getMovies() {
        let { data } = await axios.get(`https://api.themoviedb.org/3/trending/tv/week?api_key=713e5b505cc52f5aa68161a6f9c471c1`)
      ...
      <Helmet>
        ...
        <div className="container w-100 problem ">
            <div className="row my-2 gy-4 px-2">
                <input onChange={search} type="text" className='form-control my-2' placeholder='Search For Tv' />
